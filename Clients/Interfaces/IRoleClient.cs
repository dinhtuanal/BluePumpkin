...
namespace Clients.Interfaces
{
    public interface IRoleClient
    {
        ...
        public Task<List<ApplicationUser>> GetUserInRole(string roleName, string token);
        public Task<List<ApplicationUser>> GetUserNotInRole(string roleName, string token);
    }
}
